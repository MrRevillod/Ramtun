...
<main class="min-h-dvh px-4 py-8 sm:px-6 sm:py-12">
	<div class="mx-auto flex min-h-[calc(100dvh-4rem)] max-w-5xl items-center justify-center">
		<section class="panel-surface w-full max-w-xl p-8 sm:p-10">
			...
			<h1 class="mt-2 m-0 text-3xl leading-tight text-black sm:text-[2.15rem]">Iniciar sesión</h1>
			...
			<form class="grid gap-4" onsubmit={handleSubmit}>
				...
				<button class="btn-primary mt-2 w-full text-base" type="submit" disabled={loading}>
