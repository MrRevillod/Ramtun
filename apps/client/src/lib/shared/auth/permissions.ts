...
export const isTeachingRole = (role?: User["role"]): boolean => isFunc(role) || isAdmin(role)
export const canManageUsers = (role?: User["role"]): boolean => isFunc(role) || isAdmin(role)
